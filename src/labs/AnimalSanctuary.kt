...
fun main() {
    ...
    var responsibilities = listOf("feed the champs", "play a random game", "conduct a health check on Foxie")
    ...
    foxiesHealthCheck.put("temperature", 32.8)
    ...
    if (timeSpent <= totalShiftTime
        ...
        println("Congratulations for the great job, you have completed the responsibilities on time.")
